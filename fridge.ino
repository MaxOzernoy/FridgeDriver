...
void loop() {
  getTemperature();         // make it checked one minute
...
void temperatureSetRoutine(){
  if(scereenTrigger){                       //temperatureSetRoutine
    tempBorders();
...
void relayTrigger(){
  ...
  if(temperature <= deactTemperature){
    digitalWrite(relayPin, LOW);
...
void tempBorders(){
  ...
  display.println(deactTemperature);
